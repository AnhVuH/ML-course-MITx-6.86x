...
def epsilon_greedy(state_1, state_2, q_func, epsilon):
    ...
    """
    # TODO Your code here
    max_q_index = np.argmax(q_func[state_1][state_2])

    exploitation_action_index = max_q_index // NUM_OBJECTS
    exploitation_object_index = max_q_index % NUM_OBJECTS
...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    # TODO Your code here
    if not terminal:
        max_next_q = np.ndarray.max(q_func[next_state_1][next_state_2])
        ...
        q_func[current_state_1, current_state_2, action_index,
               ...
               object_index] + ALPHA *(reward + GAMMA * max_next_q)
    else:
        q_func[current_state_1, current_state_2, action_index,
               object_index] = (1-ALPHA) * q_func[current_state_1, current_state_2, action_index,
...
if __name__ == '__main__':
    ...
    # q_func = np.zeros((NUM_ROOM_DESC, NUM_QUESTS, NUM_ACTIONS, NUM_OBJECTS))
    # q_func[1][2][1][3]=2
    # epsilon_greedy(1, 2, q_func, TRAINING_EP)
