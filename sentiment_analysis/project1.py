...
def average_perceptron(feature_matrix, labels, T):
    ...
    return total_theta/(T*n), total_theta_0/(T*n)
    raise NotImplementedError
#pragma: coderesponse end
...
def classifier_accuracy(
    ...
    predicted_train_labels = classify(train_feature_matrix, train_theta, train_theta_0)

    predicted_valid_labels = classify(val_feature_matrix, train_theta, train_theta_0)


    train_accuracy = accuracy(predicted_train_labels,train_labels)

    val_accuracy = accuracy(predicted_valid_labels,val_labels)
